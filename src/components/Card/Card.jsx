...
import { addFav,removeFav,countNumber } from '../../redux/actions';
...
const dispatch=useDispatch();
   ...
   return (
         ...
         {isFav ? (
          <button className={classes['button']} onClick={handleFavorite}> <FaHeart style={{color:'red'}} />  </button>
         ) : (
          <button className={classes['button']}  onClick={handleFavorite}><FaHeart style={{color:'white'}} /></button>
         )}
