    ...
    <div className={classes.about}>
        ...
        <h2 className={classes['about-h2']}>I love to build amazing apps.</h2>
         ...
         <br /> <br />
          ...
          Throughout my career, I have gained hands-on experience in the software development life cycle, and consistently contributed to the success of the organizations I worked with. 
          <br /> In addition, I hold a degree in Computer Science from Universidad Privada del Este (2017).
            </p>
    </div>
    </>)
}
